...
import com.sbs.apiced_web.services.DrejManager;
...
public class ChartJsView implements Serializable {
    ...
    //private PieChartModel pieModelMcByCategPro; // mc par categ pro
    ...
    private DonutChartModel donutModelNbreMcByOp; //mc par operateur telecom

    private ScatterChartModel scatterModel;

    private Long nbreMcAbonneAirtel;
    private Long nbreMcAbonneTigo;
    private Number nbreMcNiveauUn;
    private Number nbreMcNiveauDeux;
    private Number nbreMcNiveauTrois;
    private List<String> nomsDrej = new ArrayList<>();
    ...
    @EJB
    private DrejManager drejManager;

    @PostConstruct
    public void init() {
        createPieModel();
        //createpieModelMcByCategPro();
        ...
        createDonutModel();
        //par moi 
//        createDonutModelNbreMcByOp();
        createScatterModel();
        //recup la liste des noms de toutes les localites
    ...
    private void createPieModel() {
        ...
        labels.add("Abonnés AIRTEL");
        labels.add("Abonnés MOOV AFRICA");
        data.setLabels(labels);

        pieModel.setData(data);
    }

//    private void createpieModelMcByCategPro() { //stats des mc par categories pro
//        
//        pieModel = new PieChartModel();
//        ChartData data = new ChartData();
//        PieChartDataSet dataSet = new PieChartDataSet();
//        
//        List<Number> values = new ArrayList<>();
//        values.add(mcMgr.nbreMcByCateg("CAT3"));
//        values.add(mcMgr.nbreMcByCateg("CAT2"));
//        values.add(mcMgr.nbreMcByCateg("CAT1"));
//        dataSet.setData(values);
//
//        List<String> bgColors = new ArrayList<>();
//        bgColors.add("rgb(255, 99, 132)");
...
//
//        //pieModel.setData(data);
//        //pieModelMcByCategPro.setData(data);
//    }
    ...
    public void createBarModel() {
        ...
        //recuperation de la liste des noms de drejs
        nomsDrej = drejManager.listNomsDrej();
        int a = 255, b = 99, c = 130;
        String aString = new String();
        String bString = new String();
        String cString = new String();
        System.out.println("liste des drejs");
        
        for (String string : nomsDrej) {
            a++;
            b++;
            c++;
            ...
            System.out.println( bgColor.add("rgba(" + aString + "," + bString + "," + cString + "," + " 0.2)"));
            bgColor.add("rgba(" + aString + "," + bString + "," + cString + "," + " 0.2)");
            //System.out.println("->" + string);
            values.add(mcMgr.nbreMcByDrej(string));
            labels.add(string);
        }
//
//        System.out.println("les nbre de mcs par drej");
...
//        }
        ...
        title.setText("Nombre de maitres communautaires par DREJ");
        options.setTitle(title);
    ...
    public void createBarModel2() {
        ...
        BarChartDataSet barDataSet = new BarChartDataSet();
        barDataSet.setLabel("AIRTEL");
        barDataSet.setBackgroundColor("rgba(255, 0, 0, 0.1)");
        ...
        Title title = new Title();
        title.setDisplay(true);
        title.setText("Opérateurs télécoms");
        options.setTitle(title);
    ...
    public void createDonutModel() {
        ...
        bgColors.add("rgb(54, 162, 235)");
        bgColors.add("rgb(255, 205, 86)");
        bgColors.add("rgb(154,205,50)");
        dataSet.setBackgroundColor(bgColors);

        data.addChartDataSet(dataSet);
        List<String> labels = new ArrayList<>();
        labels.add("Catégorie 1");
        labels.add("Catégorie 2");
        labels.add("Catégorie 3");
        labels.add("Bourse");
        data.setLabels(labels);
...
//    public void createDonutModelNbreMcByOp() {
//        donutModelNbreMcByOp = new DonutChartModel();
//        ChartData data = new ChartData();
//
//        DonutChartDataSet dataSet = new DonutChartDataSet();
//        List<Number> values = new ArrayList<>();
//        values.add(mcMgr.nbreMcByNomOp("AIRTEL"));
//        //values.add(50);
//        values.add(mcMgr.nbreMcByNomOp("TIGO"));
//        dataSet.setData(values);
//
//        List<String> bgColors = new ArrayList<>();
//        bgColors.add("rgb(255, 99, 132)");
...
//        data.setLabels(labels);
//
//        donutModelNbreMcByOp.setData(data);
//    }
    ...
    public DonutChartModel getDonutModelNbreMcByOp() {
        return donutModelNbreMcByOp;
    }

    public void setDonutModelNbreMcByOp(DonutChartModel donutModelNbreMcByOp) {
        this.donutModelNbreMcByOp = donutModelNbreMcByOp;
    }
    ...
    public Long getNbreMcAbonneAirtel() {
        return nbreMcAbonneAirtel;
    }

    public void setNbreMcAbonneAirtel(Long nbreMcAbonneAirtel) {
        this.nbreMcAbonneAirtel = nbreMcAbonneAirtel;
    }

    public Long getNbreMcAbonneTigo() {
        return nbreMcAbonneTigo;
    }

    public void setNbreMcAbonneTigo(Long nbreMcAbonneTigo) {
        this.nbreMcAbonneTigo = nbreMcAbonneTigo;
    }

    public Number getNbreMcNiveauUn() {
        return nbreMcNiveauUn;
    }

    public void setNbreMcNiveauUn(Number nbreMcNiveauUn) {
        this.nbreMcNiveauUn = nbreMcNiveauUn;
    }

    public Number getNbreMcNiveauDeux() {
        return nbreMcNiveauDeux;
    }

    public void setNbreMcNiveauDeux(Integer nbreMcNiveauDeux) {
        this.nbreMcNiveauDeux = nbreMcNiveauDeux;
    }

    public Number getNbreMcNiveauTrois() {
        return nbreMcNiveauTrois;
    }

    public void setNbreMcNiveauTrois(Integer nbreMcNiveauTrois) {
        this.nbreMcNiveauTrois = nbreMcNiveauTrois;
    }
...
//    public PieChartModel getPieModelMcByCategPro() {
//        return pieModelMcByCategPro;
//    }
//
//    public void setPieModelMcByCategPro(PieChartModel pieModelMcByCategPro) {
//        this.pieModelMcByCategPro = pieModelMcByCategPro;
//    }
    public OperateurTelcoManager getOpTelcoManager() {
        return opTelcoManager;
    }

    public void setOpTelcoManager(OperateurTelcoManager opTelcoManager) {
        this.opTelcoManager = opTelcoManager;
    }

    public DrejManager getDrejManager() {
        return drejManager;
    }

    public void setDrejManager(DrejManager drejManager) {
        this.drejManager = drejManager;
    }
